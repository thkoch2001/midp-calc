...
public final class CmdDesc
{
    public static String getStr( int id, boolean brief ) {
        switch( id ) {
            ...
            case CalcEngine.SUMXX:return brief ? "ßx²" : "stat/sums/ßx²";
            case CalcEngine.SUMLNX:return brief ? "ß£x" : "stat/sums/ß£x";
            case CalcEngine.SUMLN2X:return brief ? "ß£²x" : "stat/sums/ß£²x";
            case CalcEngine.SUMY:return brief ? "ßy" : "stat/sums/ßy";
            case CalcEngine.SUMYY:return brief ? "ßy²" : "stat/sums/ßy²";
            case CalcEngine.SUMLNY:return brief ? "ß£y" : "stat/sums/ß£y";
            case CalcEngine.SUMLN2Y:return brief ? "ß£²y" : "stat/sums/ß£²y";
            case CalcEngine.SUMXY:return brief ? "ßxy" : "stat/sums/ßxy";
            case CalcEngine.SUMXLNY:return brief ? "ßx£y" : "stat/sums/ßx£y";
            case CalcEngine.SUMYLNX:return brief ? "ßy£x" : "stat/sums/ßy£x";
            case CalcEngine.SUMLNXLNY:return brief ? "ß£x£y" : "stat/sums/ß£x£y";
            ...
            case CalcEngine.TRANSP:return brief ? "A^T" : "matrix/A^T";
