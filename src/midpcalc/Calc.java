    ...
    implements CommandListener
{
    ...
    public void askNewProgram(String name, int n) {
        if (newProgram == null) {
            newProgram = new TextBox("New program", "",
    ...
    public void resetRequested() {
        if (resetConfirmation == null) {
            ...
            resetConfirmation.append("Are you sure you want to reset and "+
                                     "exit, erasing all data?");
            if (okCommand == null) {
                okCommand = new Command("Ok", Command.OK, 1);
                cancelCommand = new Command("Cancel", Command.CANCEL, 1);
            }
    ...
    public void outOfMemory() {
        displayMessage("Error", "Out of memory. You may be able to continue "+
                 "using the application, but to be safe you should exit now.");
    }
